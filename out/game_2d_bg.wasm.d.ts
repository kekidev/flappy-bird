...
export function wasm_bindgen__convert__closures__invoke0_mut__h0c876abb0f3c9c7d(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h8010bfefee3da35b(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h48654f42d6e74174(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h2de6c2215fd043e2(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h8bb301948161c233(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hb4c9d1b524f0f916(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he72d014cad4c1511(a: number, b: number, c: number): void;
